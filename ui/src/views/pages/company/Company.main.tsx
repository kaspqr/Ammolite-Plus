...
import { CONTRACT_MAIN } from "./contract/contract.routes.consts";
import { ContractMainPanel } from "./contract/ContractsMain.panel";
import { COST_CENTER_MAIN } from "./cost-center/cost-center.routes.consts";
import { CostCenterMainPanel } from "./cost-center/CostCenterMain.panel";
...
import { DIVISION_MAIN } from "./division/division.routes.consts";
import { DivisionMainPanel } from "./division/DivisionMain.panel";
          ...
          <div className="col">
            <Card>
                  ...
                  <Col lg="12" className="d-flex flex-column justify-content-end">
                    <FormGroup>
                      ...
                      <Button
                        color="primary"
                        type="submit"
                        onClick={() => setActiveTab(DIVISION_MAIN)}
                      >
                        Division
                      </Button>
                      <Button
                      ...
                      <Button
                        color="primary"
                        type="submit"
                        onClick={() => setActiveTab(COST_CENTER_MAIN)}
                      >
                        Cost Center
                      </Button>
                      <Button
                      ...
                      <Button
                        color="primary"
                        type="submit"
                        onClick={() => setActiveTab(CONTRACT_MAIN)}
                      >
                        Contracts
                      </Button>
                    </FormGroup>
              ...
              <TabContent activeTab={activeTab}>
                ...
                <TabPane tabId={CONTRACT_MAIN}>
                  <ContractMainPanel />
                </TabPane>
                <TabPane tabId={COST_CENTER_MAIN}>
                  <CostCenterMainPanel />
                </TabPane>
              </TabContent>
            </Card>
